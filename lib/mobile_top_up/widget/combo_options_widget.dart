...
class ComboOptionsWidget extends StatelessWidget {
  final MobileTopUpController controller;

  const ComboOptionsWidget({super.key, required this.controller});

  @override
  Widget build(BuildContext context) {
    List<Map<String, String>> comboPackages = [
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Obx(() {
            final isSelected = controller.selectedComboPackage.value == package['min'];
